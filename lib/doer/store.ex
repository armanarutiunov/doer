defmodule Doer.Store do
  ...
  defp dir, do: Path.expand("~/.doer")
  defp legacy_path, do: Path.join(dir(), "todos.json")
  defp all_todos_path, do: Path.join(dir(), "all-todos.json")
  defp projects_dir, do: Path.join(dir(), "projects")
